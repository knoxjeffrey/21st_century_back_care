...
import FluidVid from '../utilities/FluidVid.jsx';

const ticks_path = require('../images/Yes.svg');
          ...
          <div className="row">
            ...
            <div className="col-md-7">
              <div className="fluidvids-vimeo">
                <FluidVid src="https://player.vimeo.com/video/139934432" />
              </div>
            </div>
            ...
            <div className="col-md-5">
              ...
              <div className="home-benefits">
                <div className="home-ticks">
                  <img className="ticks" src={ticks_path} alt="Tick" />
